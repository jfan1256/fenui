...
function App() {
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            // Prod (Ngrok)
            const ngrok_config = require('../../ngrok/ngrok.json');
            let ngrokLink = ngrok_config.http_link;
            ngrokLink += '/generate_plot';
            const response = await axios.post(ngrokLink, { "input_str": userInput });
